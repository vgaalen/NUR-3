...
\lstinputlisting[firstline=1, lastline=304]{ex1.py}
...
\lstinputlisting[firstline=308, lastline=323]{ex1.py}
...
The code used for this subquestion is:
\lstinputlisting[firstline=325, lastline=416]{ex1.py}
...
The code used for this subquestion is:
\lstinputlisting[firstline=418, lastline=451]{ex1.py}
...
The code used for this subquestion is:
\lstinputlisting[firstline=453]{ex1.py}